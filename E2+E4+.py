# -*- coding: utf-8 -*-
"""
Created on Fri Apr 24 15:48:12 2020
...
#ax.errorbar(exp_data_1["N"], exp_data_1["E4+"]/exp_data_1["E2+"], fmt='--o', elinewidth=2, c='red')
#ax.errorbar(exp_data_3["N"], exp_data_3["E4+"]/exp_data_3["E2+"], fmt='--o', elinewidth=2, c='green')
ax.errorbar(exp_data_5["N"], exp_data_5["E4+"]/exp_data_5["E2+"], fmt='--o', elinewidth=2, c='black')
#ax.errorbar(exp_data_7["N"], exp_data_7["E4+"]/exp_data_7["E2+"], fmt='--o', elinewidth=2, c='black')
#ax.text(63 ,1.5 , '$\ _{36}Kr$' , rotation=0, fontsize=15,  color='red')
#ax.text(63 ,1.75 , '$\ _{38}Sr$' , rotation=0, fontsize=15,  color='green')
ax.text(61 ,2.0 , '$\ _{40}Zr$' , rotation=0, fontsize=15,  color='black')
#ax.text(63 ,2.25 , '$\ _{42}Mo$' , rotation=0, fontsize=15,  color='black')
...
ax.set_ylabel('E(4$^+$)/E(2$^+$)',fontsize=20)
plt.tick_params(
